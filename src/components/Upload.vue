<template>
	<el-upload class="avatar-uploader" action="http://localhost:3003/api/upload/common" :show-file-list="false" :data="{type:'avatar'}" :on-success="handleAvatarSuccess" :before-upload="beforeAvatarUpload">
		<template v-if="url">
